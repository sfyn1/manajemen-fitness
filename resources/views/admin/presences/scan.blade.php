...
<div class="container-fluid">{{-- PAGE HEADER (BIAR TIDAK NEMBUS HEADER) --}} < div class = "page-header d-print-none mb-4" > <div class="row align-items-center">
    <div class="col">
        ...
        <div class="text-muted">
            Scan QR Code member untuk mencatat kehadiran secara realtime.
        </div>
    </div>
</div>
...
<div class="col-lg-8">
    <div class="card border-0 shadow-sm h-100">
        ...
        <div class="card-body text-center">
            ...
            <div id="reader" class="rounded overflow-hidden" style="width:100%;"></div>

            <div class="mt-3">
                <small class="text-muted">
                    Arahkan QR Code kartu member ke kamera.
                </small>
            </div>
                ...
                <li
                    ...
                    <img
                        ...
                        <div>
                            ...
                            <small class="text-muted time-display">{{ date('H:i', strtotime($presence->check_in_time)) }}
                                WIB</small>
                        </div>
...
// --- KONFIGURASI AUDIO (FILE LOKAL) --- Menggunakan helper asset() agar
// mengarah ke folder public/audio
...
function handleResponse(data) {
    ...
    if (data.status === 'success') {
        ...
        const currentCount = list
            .querySelectorAll('li:not(.text-center)')
            .length;
