...
@section('content') <script src = "https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js" > </script> <script src = "https://cdn.jsdelivr.net/npm/sweetalert2@11" > </script>
...
<div class="row justify-content-center">
    <div class="col-md-8 col-lg-6">
        ...
        <form
            id="pdfForm"
            action="{{ route('admin.members.print-pdf-image') }}"
            method="POST"
            style="display:none;">
            @csrf
            <input type="hidden" name="image" id="imageInput">
                <input
                    type="hidden"
                    name="name"
                    value="{{ str_replace(' ', '-', $user->name) }}"></form>

                <div
                    id="card-capture-area"
                    style="background-color: #ffffff; padding: 20px; border-radius: 10px; width: fit-content; margin: 0 auto;">
                    <div class="id-card">
                        ...
                        <div class="card-header-custom">
                            <div class="d-flex align-items-center justify-content-between">
                                <div>
                                    <h5
                                        class="m-0 fw-bold text-white tracking-wide"
                                        style="text-shadow: 1px 1px 2px rgba(0,0,0,0.3);">GINTUNG FITNESS</h5>
                        ...
                        <div class="card-body-custom d-flex align-items-center">
                            <div class="text-center pe-4 border-end" style="border-color: #eee !important;">
                                <div class="avatar-box mb-3">
                                    <img
                                        src="{{ $user->member->photo ? asset('storage/' . $user->member->photo) : asset('template/assets/images/avatar/1.png') }}"
                                        class="img-fluid rounded-circle"
                                        style="width: 100px; height: 100px; object-fit: cover; border: 3px solid white;"></div>
                    ...
                    <div class="text-center mt-5 d-print-none gap-2">
                        <a
                    ...
                    .addEventListener('click', function () {
                        captureCard(function (canvas) {
                            ...
                            setTimeout(() => {
                                Swal.close();
                                Swal.fire(
                                    {icon: 'success', title: 'PDF Siap!', text: 'File PDF sedang didownload.', timer: 2000, showConfirmButton: false}
                                );
                            }, 1000);
                        });
                    });
                ...
                document
                    ...
                    .addEventListener('click', function () {
                        captureCard(function (canvas) {
                            ...
                            Swal.fire(
                                {icon: 'success', title: 'Selesai!', text: 'Foto kartu berhasil disimpan.', timer: 2000, showConfirmButton: false}
                            );
                        });
                    });
        ...
        <style>
            ...
            .card-header-custom {
                background: linear-gradient(135deg, #3454d1 0%, #2f4ac1 100%);
                padding: 20px 30px;
                color: white;
            }
            .card-body-custom {
            ...
            .card-bg {
                ...
                width: 100%;
                height: 100%;
                background-image: radial-gradient(#3454d1 0.5px, transparent 0.5px);
