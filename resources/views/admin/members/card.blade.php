    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
                    ...
                    <div class="card-body-custom d-flex align-items-center">
                        <div class="text-center pe-4 border-end" style="border-color: #eee !important;">
                            <div class="avatar-box mb-3">
                                <img src="{{ asset('template/assets/images/avatar/1.png') }}" class="rounded-circle" width="90" alt="User" style="border: 3px solid #3454d1; padding: 2px; background: white;">
                            </div>
            ...
            <div class="text-center mt-5 d-print-none gap-2">
                ...
                <button type="button" id="btn-download-pdf" class="btn btn-danger rounded-pill px-4">
                    <i class="feather-file-text me-2"></i> Download PDF
                </button>

                <button type="button" id="btn-download-jpg" class="btn btn-success rounded-pill px-4">
                    <i class="feather-image me-2"></i> Download Foto
                </button>
            </div>
