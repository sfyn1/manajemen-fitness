...
<html lang="id">
    ...
    <head>
        ...
        <link
            rel="shortcut icon"
            type="image/x-icon"
            href="{{ asset('template/assets/images/favicon.ico') }}"/>
        <link
            rel="stylesheet"
            type="text/css"
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="{{ asset('template/assets/vendors/css/feather.min.css') }}"/>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto text-center hero-content">
                        ...
                        <h1 class="hero-title">Kelola Kebugaran dengan
                            <br>
                            Teknologi Modern</h1>
                        <p class="hero-subtitle">
                            Solusi digital untuk manajemen membership, presensi QR Code, dan penjadwalan
                            latihan di Gintung Master Fitness. Efisien, Akurat, dan Real-time.
                        </p>
                        <div class="d-flex justify-content-center gap-3">
                            <a
                                href="{{ route('admin.members.index') }}"
                                class="btn btn-primary btn-lg px-5 py-3 rounded-pill fw-bold">
                                Mulai Sekarang
                            </a>
                            <a
                                href="#fitur"
            ...
            <div class="container">
                <div class="row text-center mb-5">
                    <div class="col-lg-8 mx-auto">
                        ...
                        <p class="text-muted lead">Sistem ini dirancang untuk mengatasi masalah manual
                            yang sering terjadi di operasional gym sehari-hari.</p>
                    </div>
                </div>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <p class="text-muted">
                                Pencatatan data member yang terpusat. Monitoring masa aktif, perpanjangan paket,
                    ...
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <p class="text-muted">
                                Proses check-in yang cepat hanya dengan scan QR Code. Mengurangi antrian dan
                                memastikan data kunjungan yang akurat.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="feature-card">
                            ...
                            <p class="text-muted">
                                Atur jadwal Personal Trainer dan kelas latihan (Muaythai, Boxing) dengan mudah
                                tanpa bentrok jadwal manual.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-end mt-3 mt-md-0">
                        <p class="mb-0 fs-12">&copy;
                            {{ date('Y') }}
                            Sufyan Dzaki. Skripsi UIN Jakarta.</p>
                    </div>
                </div>
            </div>
        </footer>
